...
You can include your code snipped by embeding ruby code: +<%= bob_code filename: 'filename' %>+. The file must be in +code/+ directory. Embeded script would look like this:
